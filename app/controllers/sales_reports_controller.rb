class SalesReportsController < ApplicationController
  ...
  def generate
    ...
    @sales_report.seller.id = params[:sales_report][:seller_id]
    ...
    # elsif !@sales_report.initial_date.blank? && !@sales_report.final_date.blank?
    ...
    elsif !@sales_report.seller.id.blank?
      query = query + " employee_id = " + @sales_report.seller.id.to_s
    end
    puts "query " + query
